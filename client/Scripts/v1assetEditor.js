  ...
  define(["backbone", "underscore", "toastr", "jquery", "v1json", "jquery.mobile", "jsrender"], function(Backbone, _, toastr, $, v1json) {
    ...
    VersionOneAssetEditor = (function() {
      function VersionOneAssetEditor(options) {
        ...
        continueSettingOptions = (function(_this) {
          return function() {
            var key;
      ...
      VersionOneAssetEditor.prototype.initialize = function() {
        ...
        $("#list").live("pagebeforeshow", (function(_this) {
          return function() {
            return _this.listFetchIfNotLoaded();
          };
        })(this));
        $("#projectsPage").live("pagebeforeshow", (function(_this) {
          return function() {
      ...
      VersionOneAssetEditor.prototype.configureProjectSearch = function() {
        ...
        projectSearch.pressEnter((function(_this) {
          return function(e) {
      ...
      VersionOneAssetEditor.prototype.loadRequests = function(projectIdref) {
        ...
        assets = $("#assets");
        assets.empty();
        $.ajax(request).done((function(_this) {
      ...
      VersionOneAssetEditor.prototype.listItemFormat = function(item) {
        ...
        templ.children(".assetItem").bind("click", (function(_this) {
          return function(e) {
            var href, target;
            target = $(e.currentTarget);
      ...
      VersionOneAssetEditor.prototype.projectItemFormat = function(item) {
        ...
        templ.children(".projectItem").bind("click", (function(_this) {
          return function(e) {
      ...
      VersionOneAssetEditor.prototype.newAsset = function(modelData, href) {
        return this.configSelectLists().done((function(_this) {
          return function() {
            var asset, form;
            asset = null;
            if (modelData != null) {
      ...
      VersionOneAssetEditor.prototype.configSelectLists = function() {
        ...
        _fn = function(field) {
          ...
          ajaxRequest = $.ajax(request).done((function(_this) {
            return function(data) {
      ...
      VersionOneAssetEditor.prototype.editAsset = function(href) {
        ...
        return asset.exec().done((function(_this) {
          return function(data) {
      ...
      VersionOneAssetEditor.prototype.toggleNewOrEdit = function(type, href) {
        ...
        if (type === "new") {
          save.unbind("click");
          save.bind("click", (function(_this) {
            return function(evt) {
              evt.preventDefault();
          ...
          return saveAndNew.bind("click", (function(_this) {
            return function(evt) {
              evt.preventDefault();
      ...
      VersionOneAssetEditor.prototype.saveAsset = function(url, eventType, callback) {
        ...
        return $.ajax(request).done((function(_this) {
          return function(data) {
            data = v1json.jsonClean(data);
